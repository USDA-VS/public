...
if [ $1 == ab1 ]; then
   ...
   cp /bioinfo11/TStuber/Results/viruses/snp_analysis/pedv/script_dependents/PEDV-str-AH2012.fasta ./
   hqs="/home/shared/pedv/scriptDependents/HighestQualitySNPs.vcf"
   bioinfo="/bioinfo11/TStuber/Results/viruses/snp_analysis/pedv/newFiles"
   sharedSAN="/home/shared/mycobacterium/bovis/newFiles"
...
uis2, suis3, suis4, canis, ceti1, ceti2, ovis, bovis, pedv"
    exit 1
fi
...
mv *coverage.hist* ../unmappedReads
rm *_abyss*
######################
